...
lastmod: 2023-08-18T18:41:36+08:00
draft: false
weight: 1009
---
...
-   游戏角色视角垂直旋转即Camera组件垂直旋转, 可以用来校准处垂直方向上的瞄准偏移 <br/>
...
### 在蓝图中获取Camera组件旋转分量 {#在蓝图中获取camera组件旋转分量}
...
1.  `Asset Details > Additive Settings, 将Additive Anim Type设置为Mesh Space` <br/>
...
2.  对于玩家操控的游戏角色, 旋转视角时, 在水平和垂直方向都有动画; 玩家不需要看到游戏角色的侧面旋转 <br/>
3.  如果希望AI的旋转更写实, 需要配置瞄准偏移的水平输入 <br/>
...
2.  可以调试AO_BaseCharacter的(Yaw, Pitch), 编译后, 在窗口检视Idle姿势在该设置下的AimOffset效果 <br/>
    ...
    | (90, 0)  | 右转 |
    | (90, 45) | 右下 |
3.  可以调试Velocity, 查看运动时的瞄准偏移效果 <br/>
4.  获取AimRotation变量, 使用Pitch分量(垂直); Camera组件旋转的水平分量与侧面动画不一致, 不能用作Yaw的输入 <br/>
